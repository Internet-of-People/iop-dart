...
class NativeCoeusNoncedBundleBuilder {
  ...
  NativeCoeusNoncedBundleBuilder(DynamicLibrary lib) :
    delete = lib.lookupFunction<NDelete_NoncedBundleBuilder, DDelete_NoncedBundleBuilder>(
      'delete_NoncedBundleBuilder',
    ),
    // "new" and "default" are reserved words and cannot be used as a class member name
    create = lib.lookupFunction<NNoncedBundleBuilder_New, DNoncedBundleBuilder_New>(
      'NoncedBundleBuilder_new',
    ),
    add = lib.lookupFunction<NNoncedBundleBuilder_Add, DNoncedBundleBuilder_Add>(
      'NoncedBundleBuilder_add',
    ),
    build = lib.lookupFunction<NNoncedBundleBuilder_Build, DNoncedBundleBuilder_Build>(
