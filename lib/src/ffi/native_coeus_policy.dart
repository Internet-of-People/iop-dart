...
class NativeCoeusSubtreePolicies {
  ...
  NativeCoeusSubtreePolicies(DynamicLibrary lib) :
    delete = lib.lookupFunction<NDelete_CoeusSubtreePolicies, DDelete_CoeusSubtreePolicies>(
      'delete_SubtreePolicies',
    ),
    // "new" and "default" are reserved words and cannot be used as a class member name
    create = lib.lookupFunction<NCoeusSubtreePolicies_New, DCoeusSubtreePolicies_New>(
      'SubtreePolicies_new',
    ),
    withSchema = lib.lookupFunction<NCoeusSubtreePolicies_WithSchema, DCoeusSubtreePolicies_WithSchema>(
      'SubtreePolicies_with_schema',
    ),
    withExpiration = lib.lookupFunction<NCoeusSubtreePolicies_WithExpiration, DCoeusSubtreePolicies_WithExpiration>(
