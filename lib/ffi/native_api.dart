...
typedef NativeFuncBip39GeneratePhrase = Pointer<Result> Function(Pointer<Utf8> langCode);
typedef DartFuncBip39GeneratePhrase = Pointer<Result> Function(Pointer<Utf8> langCode);

typedef NativeFuncBip39ValidatePhrase =
  Pointer<Result> Function(Pointer<Utf8> langCode, Pointer<Utf8> phrase);
typedef DartFuncBip39ValidatePhrase =
  Pointer<Result> Function(Pointer<Utf8> langCode, Pointer<Utf8> phrase);

typedef NativeFuncBip39ListWords =
  Pointer<Result> Function(Pointer<Utf8> langCode, Pointer<Utf8> prefix);
typedef DartFuncBip39ListWords =
  Pointer<Result> Function(Pointer<Utf8> langCode, Pointer<Utf8> prefix);

typedef NativeFuncMaskJson =
  Pointer<Result> Function(Pointer<Utf8> json, Pointer<Utf8> keepPaths);
typedef DartFuncMaskJson =
  Pointer<Result> Function(Pointer<Utf8> json, Pointer<Utf8> keepPaths);
...
typedef NativeFuncHydraTransferTx = Pointer<Result> Function(
    Pointer<Utf8> network, Pointer<Utf8> senderPubKey, Pointer<Utf8> recipient, Int64 amount, Int64 nonce);
...
typedef NativeFuncMorpheusRewind =
  Pointer<Result> Function(Pointer vault, Pointer<Utf8> unlockPwd);
typedef DartFuncMorpheusRewind =
  Pointer<Result> Function(Pointer vault, Pointer<Utf8> unlockPwd);
...
typedef NativeFuncMorpheusPersona =
  Pointer<Result> Function(Pointer morpheus, Int32 idx);
typedef DartFuncMorpheusPersona =
  Pointer<Result> Function(Pointer morpheus, int idx);
...
typedef NativeFuncHydraPluginRewind = Pointer<Result> Function(
    Pointer vault, Pointer<Utf8> unlockPwd, Pointer<Utf8> network, Int32 idx);
typedef DartFuncHydraPluginRewind = Pointer<Result> Function(
    Pointer vault, Pointer<Utf8> unlockPwd, Pointer<Utf8> network, int idx);

typedef NativeFuncHydraPluginGet = Pointer<Result> Function(
  Pointer vault, Pointer<Utf8> network, Int32 idx);
typedef DartFuncHydraPluginGet = Pointer<Result> Function(
  Pointer vault, Pointer<Utf8> network, int idx);
...
typedef NativeFuncHydraPluginPrivateGet = Pointer<Result> Function(
    Pointer hydra, Pointer<Utf8> unlockPassword);
...
typedef NativeFuncHydraPrivateSignTx = Pointer<Result> Function(
    Pointer private, Pointer<Utf8> address, Pointer<Utf8> txJson);
typedef DartFuncHydraPrivateSignTx = Pointer<Result> Function(
    Pointer private, Pointer<Utf8> address, Pointer<Utf8> txJson);

typedef NativeFuncHydraPluginPublicGet = Pointer<Result> Function(Pointer hydra);
...
typedef NativeFuncHydraPublicAddress =
  Pointer<Result> Function(Pointer hydra, Int32 idx);
typedef DartFuncHydraPublicAddress =
  Pointer<Result> Function(Pointer hydra, int idx);
